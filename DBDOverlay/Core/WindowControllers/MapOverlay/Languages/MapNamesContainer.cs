...
namespace DBDOverlay.Core.WindowControllers.MapOverlay.Languages
{
    public static class MapNamesContainer
    {
        ...
        private static readonly List<string> deu = new List<string>()
        {
            ...
            "SCHLAFLOSES_VIERTEL.ILLUSION_DES_TRICKSTERS",
            ...
            "VERKÜMMERTE_INSEL.GEFALLENE_ZUFLUCHT",
            "VERKÜMMERTE_INSEL.FREDDY_FAZBEARS_PIZZA",
        ...
        private static readonly List<string> spa = new List<string>()
        {
            ...
            "CEMENTERIO_ABANDONADO.ARENAS_MUERTAS",
            ...
            "BARRIO_INSOMNE.DELIRIO_DEL_TRAICIONERO",
            ...
            "ISLA_MARCHITA.REFUGIO_CAÍDO",
            "ISLA_MARCHITA.FREDDY_FAZBEARS_PIZZA",
        ...
        private static readonly List<string> mex = new List<string>()
        {
            ...
            "CEMENTERIO_ABANDONADO.ARENAS_MORTALES",
            ...
            "DISTRITO_INSOMNE.DELIRIO_DEL_EMBAUCADOR",
            "SPRINGWOOD.GUARDERÍA_BADHAM",
            "SPRINGWOOD.GUARDERÍA_BADHAM_II",
            "SPRINGWOOD.GUARDERÍA_BADHAM_III",
            "SPRINGWOOD.GUARDERÍA_BADHAM_IV",
        ...
        private static readonly List<string> fra = new List<string>()
        {
            ...
            "CIMETIÈRE_ABANDONNÉ.SABLES_MORTS",
            ...
            "QUARTIER_QUI_JAMAIS_NE_DORT.ILLUSION_DU_FARCEUR",
            ...
            "ÎLE_FLÉTRIE.REFUGE_PERDU",
            "ÎLE_FLÉTRIE.FREDDY_FAZBEARS_PIZZA",
        ...
        private static readonly List<string> ita = new List<string>()
        {
            ...
            "CIMNITERO_ABBANDONATO.SABBIE_MORTE",
            ...
            "DISTRETTO_INSONNE.ILLUSIONE_DELLINGANNATORE",
            ...
            "ISOLOTTO_PUTREFATTO.REFUGIO_CADUTO",
            "ISOLOTTO_PUTREFATTO.PIZZERIA_FREDDY_FAZBEAR",
        ...
        private static readonly List<string> pol = new List<string>()
        {
            ...
            "ZAPOMNIANY_CMENTARZ.MARTWE_PIASKI",
            ...
            "BEZSENNA_DZIELNICA.UROJENIA_MAGIKA",
            ...
            "USCHNIĘTA_WYSPA.UPADŁY_AZYL",
            "USCHNIĘTA_WYSPA.PIZZERIA_FREDDY_FAZBEAR",
        ...
        private static readonly List<string> por = new List<string>()
        {
            ...
            "CEMITÉRIO_RENEGADO.AREIAS_MORTAS",
            ...
            "DISTRITO_INSONE.DESILUSÂO_DO_TRAPAÇA",
            ...
            "ILHA_SEM_VIDA.REFÚGIO_CAÍDO",
            "ILHA_SEM_VIDA.PIZZARIA_DO_FREDDY_FAZBEAR",
        ...
        private static readonly List<string> tur = new List<string>()
        {
            ...
            "TERK_EDILMIŞ_MEZARLIK.ÖLÜ_KUMLAR",
            ...
            "UYKUSUZ_MUHIT.DÜMENCININ_YANILMASI",
            ...
            "SOLUP_GITMIŞ_ADA.KAYIP_SIĞINAK",
            "SOLUP_GITMIŞ_ADA.FREDDY_FAZBEARS_PIZZA",
        ...
        private static readonly List<string> rus = new List<string>()
        {
            ...
            "ФЕРМА_КОЛДВИНД.РАЗРУШЕННЫЙ_ХЛЕВ",
            "ФЕРМА_КОЛДВИНД.ЗАБРОШЕННАЯ_СКОТОБОЙНЯ",
            "ФЕРМА_КОЛДВИНД.СГНИВШИЕ_ПОЛЯ",
            "ФЕРМА_КОЛДВИНД.ДОМ_ТОМПСОНОВ",
            "ФЕРМА_КОЛДВИНД.РУЧЕЙ_СТРАДАНИЙ",
            ...
            "ЗАБРОШЕННОЕ_КЛАДБИЩЕ.БЕСПЛОДНЫЕ_ПЕСКИ",
            ...
            "ЗАЧАХШИЙ_ОСТРОВ.ПАВШИЙ_ПРИЮТ",
            "ЗАЧАХШИЙ_ОСТРОВ.ПИЦЦЕРИЯ_ФРЕДДИ_ФАЗБЕРА",
